...
- 📝 **JSON 编辑器** — 带语法高亮的代码编辑器，支持缩放、JSON 语法自检
- 📥 **导入/导出配置** — 支持导入自定义应用配置，支持导出指定应用配置
- 🔄 **配置备份与回退** — 修改后自动备份，支持一键回退到上一个修改版本
- 💾 **写入配置到数据库** — 一键写入配置到 `com.oplus.cosa` 的 `db_game_database`
- 🔄 **支持重启应用增强服务和清除应用增强服务数据**
